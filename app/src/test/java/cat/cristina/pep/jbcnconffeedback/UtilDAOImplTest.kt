...
class UtilDAOImplTest {
    ...
    private lateinit var speakerDao: Dao<Speaker, String>
    ...
    private fun populate() {
        ...
        val speaker1 = Speaker(
                oid = 0,
                name = "Michel Schudel",
                description = "Java developer Dutch Railways",
